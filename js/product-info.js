...
function mostrarDetalles(prod) {
    ...
    let htmlContentToAppend = `
        <div class="col cardProduct center shadow">
            <div id="carouselExampleFade" class="carousel slide carousel-fade w-75 mt-4" data-bs-ride="carousel">
    ...
    htmlContentToAppend += `
        ...
        <div class="cardProduct-footer">
            ...
            <div class="cardProduct-button" id= "btn-carrito">
